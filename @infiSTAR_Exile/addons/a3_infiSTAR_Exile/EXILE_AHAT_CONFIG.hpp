...
*/
serverCommandPassword = "FuckIngNormies991REEE";
...
*/
passwordAdmin = "980985021908HHYYNKLSGSA";
...
MY_LOG_FOLDER = "infi Logs";	/* MY_LOG_FOLDER = "infiSTAR Logs"; - would create a folder named "infiSTAR Logs" */
...
class adminNameTags {
	...
	tags[] = {
		{"[Royalty]","76561198065853636"},
		{"[Royalty]","76561197989383835"},
		{"[Royalty]","UID3"},
		{"[Royalty]","76561198013856564"},
		{"[Royalty]","76561198030433683"}
	};
};

/*

DO NOT EDIT THIS FILE OR ANY INFISTAR FILE AT ALL! ONLY ADD UID'S TO THIS LIST! DO NOT WHITELIST!
...
Liberation Players (Just So This Nigga Has Them):

Wilson: 76561198058758223
IronBullet: 76561198067709898
...
adminUIDandAccess[] =
{
	...
	},
	{
		{""}, // Level 4 - !ADMIN
		{
			...
			"Teleport In Facing Direction (10m steps)","Drag and drop units on the map",
			"spectating","Delete Vehicle","FlyUp","ShowGear","Show Server Information",
			"HealSelf","HealRepairNear","Freeze","UnFreeze","Restrain","UnRestrain",
			"==== Loadouts ====","==== Base Deleter ====","Items spawn menu",
			"Remove Gear","Revive","Heal","Restore","Flip Vehicle","Move In My Vehicle","Move In Target Vehicle","Parachute Target","Eject","Eject Crew",
			"Vehicle Marker","Flag Marker (with radius)","Box/Safe/Container Marker","DeadPlayer Marker",
			"God Mode","Lower Terrain","Stealth / Invisible",
			"Mass Message","Change Time","Spawn Support-Boxes","Create Billboard","Change ViewDistance",
			"Spawn Ammo","BIS FreeRoam Cam (works with ESP)","FreeRoam Cam (does not work with ESP)",
			"Request Steam Name","showinfo",
			"UnlockLockVehicle",
			
			"Spawn Persistent Vehicles","Trader Menu",
			
			"Kill","Force Disconnect",
			"Kick (Announce)","Ban (Announce)","TempBan (Announce)",
	...
	},
	{
		{"UID1","UID2","UID3","..."}, // Level 3 - !ADMIN
		{
			...
			"HealSelf","HealRepairNear","Freeze","UnFreeze","Restrain","UnRestrain",
			"==== Base Deleter ====",
			"Remove Gear","Revive","Heal","Restore","Flip Vehicle","Move In My Vehicle","Move In Target Vehicle",
			"Vehicle Marker","Flag Marker (with radius)","DeadPlayer Marker",
			"God Mode","Lower Terrain","Stealth / Invisible",
			"Mass Message","Change Time","Spawn Support-Boxes",
			"BIS FreeRoam Cam (works with ESP)","FreeRoam Cam (does not work with ESP)",
			"Request Steam Name","showinfo",
			
			"Kill","Force Disconnect",
			"Kick (Announce)","Ban (Announce)","TempBan (Announce)",
			
			"Change Money on Player","Change Respect",
	...
	{
		{"UID1","UID2","UID3","..."}, // Level 2 - !ADMIN
		{
			"Teleport On Map Click","Teleport - Target To Me","Teleport - Me To Target",
			"spectating","Delete Vehicle","FlyUp","ShowGear","Show Server Information",
			"HealRepairNear","Freeze","UnFreeze",
			"Remove Gear","Revive","Flip Vehicle","Move In Target Vehicle",
			"Vehicle Marker","Flag Marker (with radius)","DeadPlayer Marker",
			"God Mode","Lower Terrain",
			"Mass Message",
			"BIS FreeRoam Cam (works with ESP)","FreeRoam Cam (does not work with ESP)",
			"Request Steam Name","showinfo",
	...
	{
		{"UID1","UID2","UID3","..."}, // Level 1 - !ADMIN
		{
			"Teleport - Target To Me",
			"ShowGear","Show Server Information",
			"HealRepairNear","Freeze","UnFreeze",
			"Remove Gear","Revive",
			"Lower Terrain",
			"BIS FreeRoam Cam (works with ESP)","FreeRoam Cam (does not work with ESP)",
...
chatCommands[] =
{
	{"!ts","#2784D6","1","OrbitronMedium","https://discord.gg/wRB39fU"},
	{"!discord","#2784D6","1","OrbitronMedium","https://discord.gg/wRB39fU"}
};
...
/*
	...
	DM - This is only to be enabled for development purposes, with the UIDS of:
	- Vipes
	- Rider
	- Xverion
	- Vaas
...
ESCMNUTOP = "Drunken Mongs Exile";
ESCMNUBOT = "by Exile & DM Development Team";
...
*/
useBlacklistedVariableCheck = "true"; // Default false
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall19596","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
